...
class DSCP(BaseService):
    """
    Service code for Discovery+ (https://play.discoveryplus.com).
    ...
    ALIASES = ["DSCP", "dscp", "dplus", "discoveryplus", "discovery+"]
    ...
    @staticmethod
    @click.command(name="DSCP", short_help="https://play.discoveryplus.com")
