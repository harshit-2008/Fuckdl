...
from fuckdl.objects import AudioTrack, MenuTrack, TextTrack, Title, Tracks, VideoTrack
from fuckdl.services.BaseService import BaseService
from fuckdl.utils.collections import as_list, flatten
from fuckdl.utils.MSL import MSL
from fuckdl.utils.MSL.schemes import KeyExchangeSchemes
from fuckdl.utils.MSL.schemes.UserAuthentication import UserAuthentication
...
from fuckdl.utils.gen_esn import chrome_esn_generator
...
class Netflix(BaseService):
    ...
    *MPL: FHD with Android L3, sporadically available with ChromeCDM
    ...
    def __init__(self, ctx, title, drm_system, profile, meta_lang, single):
        super().__init__(ctx)
    ...
    def manifest_as_tracks(self, manifest):
        ...
        return Tracks(
            ...
            [VideoTrack(
                ...
                kid=x["drmHeaderId"] if x["isDrm"] and self.drm_system == "widevine"  else None,
